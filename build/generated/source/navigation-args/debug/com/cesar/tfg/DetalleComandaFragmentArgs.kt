...
public data class DetalleComandaFragmentArgs(
  ...
  public companion object {
    @JvmStatic
    public fun fromBundle(bundle: Bundle): DetalleComandaFragmentArgs {
      bundle.setClassLoader(DetalleComandaFragmentArgs::class.java.classLoader)
      ...
      return DetalleComandaFragmentArgs(__comandaId)
    }

    @JvmStatic
    public fun fromSavedStateHandle(savedStateHandle: SavedStateHandle):
        DetalleComandaFragmentArgs {
      val __comandaId : String?
